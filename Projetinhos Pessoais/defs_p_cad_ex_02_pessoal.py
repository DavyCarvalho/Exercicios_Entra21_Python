...
def cadastro_endereco(id_pessoa: int, rua: str, numero: str, complemento: str, bairro: str, cidade:str, estado:str):
    
    if id_pessoa and rua and numero and complemento and bairro and cidade and estado:
        lista_endereco.append(id_pessoa)
        lista_endereco.append(rua)
        lista_endereco.append(numero)
        lista_endereco.append(complemento)
        lista_endereco.append(bairro)
        lista_endereco.append(cidade)
        lista_endereco.append(estado)
